...
#define LWHTTP_USER_AGENT L"ClientLoader"
#define LWHTTP_CONT_TYPE L"Content-Type: application/x-www-form-urlencoded"                            //for captcha


/*#define LWHTTP_USER_AGENT L"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0)"
#define LWHTTP_CONT_TYPE L"Content-Type: application/x-www-form-urlencoded"*/                               //no captcha
