...
#include <winternl.h>
#include <strsafe.h>
void ErrorExit_2(const char* lpszFunction)
{
...
namespace ManualMap
{
	...
	BOOL LoadFileFromMemory(HANDLE hProcess, LPVOID lpDll, DWORD Flags, WDLL*& wFile)
	{
		...
		if (!wFile->Image)
		{
			//std::cout << "wFile->Image: " << wFile->Image << std::endl;
			//ErrorExit_2("GetCurrentProcess");
			//ErrorExit_2("VirtualAllocEx");
			//ErrorExit_2("VirtualAlloc");
			SetLastError(1796);
			return 0;
		}
